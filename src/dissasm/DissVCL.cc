...
class EVCLdllModuleNotLoaded: public exception { };
...
static BorlandVCL* BorlandVCL_ExceptionClass;

// ---------------------------------------------------------------------
// external DLL function's.
// ---------------------------------------------------------------------
extern "C" void __stdcall BorlandVCL_Init(void);
extern "C" void __stdcall BorlandVCL_Run (void);
extern "C" void __stdcall BorlandVCL_Done(void);

BorlandVCL::BorlandVCL(void) {
    Init();
    Run ();
    Done();
}
void BorlandVCL::Init(void) {
    BorlandVCL_Init();
}
void BorlandVCL::Run(void) {
    BorlandVCL_Run();
}
void BorlandVCL::Done(void) {
    BorlandVCL_Done();
}
...
template <> debug<BorlandVCL>:: debug(int ioHandle) { }
template <> debug<BorlandVCL>:: debug(void) { cout << "voider" << endl; }
template <> debug<BorlandVCL>::~debug() { }
...
int main(int argc, char **argv)
{
    ...
    catch (EVCLdllModuleNotLoaded &e) {
        ErrorLog << "Module:\n"
                 << BorlVCL
                 << " could not be loaded."
                 << endl;
