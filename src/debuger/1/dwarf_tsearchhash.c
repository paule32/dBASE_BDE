...
struct hs_base {
    ...
    unsigned __int64 (*hashfunc_)(const void *key);
};
    ...
    unsigned long chainpos)
{
    ...
    printf("[%4lu.%02lu] 0x%08" DW_PR_DUx
        ...
        "> <key %s> %s\n",
        hashpos,chainpos,
        (Dwarf_Unsigned)(unsigned __int64)t,
        (Dwarf_Unsigned)(unsigned __int64)t->keyptr,
        v,
        descr);
}
    ...
    const char *descr, int printdetails)
{
    ...
    printf("dumptree head ptr : 0x%08" DW_PR_DUx
        ...
        " entries %" DW_PR_DUu
        " allowed %" DW_PR_DUu " %s\n",
        (Dwarf_Unsigned)(unsigned __int64)h,
    ...
    struct ts_entry **owner_ptr)
{
    ...
    struct ts_entry *q =0;
    int kc = 0;
    unsigned __int64 keyhash =  0;
    unsigned __int64 hindx = 0;
